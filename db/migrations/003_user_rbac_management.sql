...
CREATE TABLE IF NOT EXISTS account_sessions (
  ...
  KEY idx_account_sessions_lookup (token_hash, session_type, auth_version, revoked_at, expires_at),
  KEY idx_account_sessions_account (account_id, auth_version, revoked_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
